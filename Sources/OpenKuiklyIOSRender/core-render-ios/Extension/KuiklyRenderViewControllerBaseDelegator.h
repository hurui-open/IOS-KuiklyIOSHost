...
#import "../Core/KRUIKit.h"
#import "../View/KuiklyRenderView.h"
#import "Modules/KRBackPressModule.h"
#import "../Handler/KuiklyTurboDisplay/KRTurboDisplayConfig.h"
...
/// 是否向 Pager 侧派发可见性事件，默认 YES；离屏渲染场景应关闭，避免伪造页面显示/隐藏事件。
@property (nonatomic, assign) BOOL emitPagerVisibilityEvents;
...
/*
 * @brief 显式通知当前 render host 进入前台。
 */
- (void)notifyApplicationDidBecomeActive;
/*
 * @brief 显式通知当前 render host 进入后台。
 */
